...
class PropertyAnalysis(models.Model):
    ...
    garden_sqm = models.DecimalField(max_digits=8, decimal_places=2, default=0, help_text='Garden area in sqm')
    has_patio = models.BooleanField(default=False)
    patio_sqm = models.DecimalField(max_digits=8, decimal_places=2, default=0, help_text='Patio/veranda area in sqm')
    parking_sqm = models.DecimalField(max_digits=8, decimal_places=2, default=0, help_text='Parking space area in sqm')
