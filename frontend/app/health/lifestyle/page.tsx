...
const RECOMMENDATIONS: Recommendation[] = [
  ...
  },
  {
    icon: '❤️',
    priority: 'high',
    title: { en: 'Blood Pressure Monitoring Recommended', bg: 'Препоръчва се проследяване на кръвното налягане' },
    description: {
      en: 'Elevated glucose + liver enzyme changes indicate cardiovascular risk. Regular BP monitoring is critical. Track your blood pressure alongside blood results for integrated cardiovascular risk assessment.',
      bg: 'Повишена глюкоза + промени в чернодробните ензими показват сърдечно-съдов риск. Редовното мониториране на кръвното налягане е критично. Проследявайте кръвното налягане заедно с кръвните резултати.',
    },
