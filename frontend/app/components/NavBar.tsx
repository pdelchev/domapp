...
const NAV_ITEMS = [
  ...
  { href: '/investments/portfolios', key: 'investments.portfolios' },
  { href: '/investments/watchlist', key: 'investments.watchlist' },
  { href: '/investments/dividends', key: 'investments.dividends' },
  { href: '/investments/tax-report', key: 'investments.tax_report' },
...
const DESKTOP_NAV: DesktopNavItem[] = [
  ...
  { href: '/investments', key: 'nav.investments', sub: [
    { href: '/investments', key: 'investments.dashboard' },
    { href: '/investments/portfolios', key: 'investments.portfolios' },
    { href: '/investments/watchlist', key: 'investments.watchlist' },
    { href: '/investments/dividends', key: 'investments.dividends' },
    { href: '/investments/tax-report', key: 'investments.tax_report' },
