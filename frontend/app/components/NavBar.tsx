...
const MODULES: Module[] = [
  ...
  { id: 'lifestyle', icon: 'M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z', color: 'bg-teal-500', href: '/lifestyle', key: 'nav.lifestyle', section: 'life' },
...
function getActiveSection(pathname: string): string {
  ...
  if (pathname.startsWith('/lifestyle')) return 'life';
